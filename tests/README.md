...
12. Ajouter un créneau `quiz`, démarrer une session Google puis naviguer jusqu'à ce créneau. Dans Monitoring, renseigner une question et deux à quatre propositions, puis enregistrer. Le téléphone doit basculer automatiquement sur le quiz sans rechargement. Répondre une fois, recharger le téléphone et vérifier que « Réponse enregistrée » reste affiché. Monitoring doit incrémenter son compteur sans afficher la répartition ni la bonne réponse. Passer à la slide suivante : le téléphone doit quitter le quiz. Vérifier enfin qu'une tentative d'envoi après ce changement est refusée et qu'un Room d'une seconde session ne reçoit aucune réponse de la première.